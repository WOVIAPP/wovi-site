...
export default function Page() {
  ...
  // ✅ NEW: Scroll helper for "Pick a plan"
    ...
    <>
      ...
      <div style={S.page}>
        ...
        <header style={S.topbar}>
          ...
          <nav style={S.nav}>
            <button style={S.navLinkBtn} onClick={scrollToPricing}>
              Pricing
            </button>
          ...
          <div style={S.heroGrid} className="heroGridMobileFix">
            ...
            <div style={S.heroCard}>
              ...
              <div style={S.heroCtas}>
                {/* ✅ CHANGED: Pick a plan now scrolls to pricing */}
                <button style={S.ctaPrimary} onClick={scrollToPricing}>
                  Pick a plan
                </button>
